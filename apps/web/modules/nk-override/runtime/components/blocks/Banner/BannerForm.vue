  ...
  <div class="block-slider-edit">
    <div :data-testid="`slide-settings-${activeSlide}`">
      ...
      >
        ...
        <div class="mb-6">
          <UiFormLabel class="mb-1">{{ getEditorTranslation('image-link-label') }}</UiFormLabel>
          <SfInput
            v-model="banner.content.image.link"
            name="link"
            data-testid="slider-image-link"
            type="text"
            :placeholder="getEditorTranslation('image-link-placeholder')"
          />
        </div>
      </UiAccordionItem>
...
<i18n lang="json">
{
  "en": {
    ...
    "image-link-label": "Image Link Target",
    "image-link-placeholder": "Enter URL here",
